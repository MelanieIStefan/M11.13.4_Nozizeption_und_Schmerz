...
\begin{itemize}
    ...
    \item 
    Kommen in Hirnstamm, Rückenmark, Hypothalamus und Hypophyse vor (prä- und postsynaptisch)
\item Verschiedene Rezeptorklassen (\(\mu\), \(\delta\), \(\kappa\)) sind relativ, aber nicht komplett selektiv für bestimmte Opioid-Klassen
\item
Alle Rezeptoren sind G-Protein gekoppelte Rezeptoren vom Typ G\textsubscript{i}
\item
Das heißt: \pause Sie hemmen Adenylatzyklase
\item 
Wirkung: Unterbrechen die Weiterleitung in der Schmerzbahn
\begin{itemize}
\item 
Präsynaptisch:  Hemmen Freisetzung von Neurotransmittern
\item 
Postsynaptisch: verursachen Hyperpolarisation 
\end{itemize}
\end{itemize}
